					...
					<div class="grid rooms-grid">
						<div class="grid-item featured-rooms">
							<div class="image-wrap">
								...
								<div class="room-name">
									{listRoom && listRoom[0]['roomType']}
								</div>
							</div>
							<div class="room-info-wrap">
								<span class="room-price">
									{listRoom && '$' + listRoom[0]['roomPrice']}{' '}
						...
						<div class="grid-item featured-rooms">
							<div class="image-wrap">
								...
								<div class="room-name">
									{listRoom && listRoom[1]['roomType']}
								</div>
							</div>
							<div class="room-info-wrap">
								<span class="room-price">
									{listRoom && '$' + listRoom[1]['roomPrice']}{' '}
									<span class="per-night">Per night</span>
								</span>
								<p class="paragraph">
						...
						<div class="grid-item featured-rooms">
							<div class="image-wrap">
								...
								<div class="room-name">
									{listRoom && listRoom[2]['roomType']}
								</div>
							</div>
							<div class="room-info-wrap">
								<span class="room-price">
									{listRoom && '$' + listRoom[2]['roomPrice']}{' '}
									<span class="per-night">Per night</span>
								</span>
								<p class="paragraph">
						...
						<div class="grid-item featured-rooms">
							<div class="image-wrap">
								...
								<div class="room-name">
									{listRoom && listRoom[3]['roomType']}
								</div>
							</div>
							<div class="room-info-wrap">
								<span class="room-price">
									{listRoom && '$' + listRoom[3]['roomPrice']}{' '}
									<span class="per-night">Per night</span>
								</span>
								<p class="paragraph">
						...
						<div class="grid-item featured-rooms">
							<div class="image-wrap">
								...
								></img>
								<div class="room-name">
									{listRoom && listRoom[4]['roomType']}
								</div>
							</div>
							<div class="room-info-wrap">
								<span class="room-price">
									{listRoom && '$' + listRoom[4]['roomPrice']}{' '}
									<span class="per-night">Per night</span>
								</span>
								<p class="paragraph">
						...
						<div class="grid-item featured-rooms">
							<div class="image-wrap">
								...
								<div class="room-name">
									{listRoom && listRoom[5]['roomType']}
								</div>
							</div>
							<div class="room-info-wrap">
								<span class="room-price">
									{listRoom && '$' + listRoom[5]['roomPrice']}{' '}
									<span class="per-night">Per night</span>
								</span>
								<p class="paragraph">
